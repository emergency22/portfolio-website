...
export default function AboutMe() {
    ...
    <div id="aboutMe">
        ...
        <div className="aboutMeStory">
            ...
            <p>Following graduation, I obtained my AWS Certified Cloud Practitioner certification, completed an Advanced SQL course, and I have self-studied Spring Boot and React (This website was made with React).</p>
